...
def getStatus(video_path, out_path):
    ...
    status_list = [['rule', 'stage_num', 'fps', 'frame_all', 'frame_start', 'frame_end'],
                   [rule, stage_num, fps, frame_all, frame_start, frame_end]]
...
def main():
    ...
    for day, match in match_list:
        video_path = '.\\DAY' + str(day) + '\\PL-DAY' + str(day) + '_' + match + '.avi'  
